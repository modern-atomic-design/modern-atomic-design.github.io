...
import { b as useNuxtApp, d as asyncDataDefaults, u as useRuntimeConfig, c as createError, e as useRequestEvent } from './server.mjs';
import { I as withBase, w as withLeadingSlash, m as joinURL, o as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-jeOdXIrT.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CBdwNUCZ.mjs.map
