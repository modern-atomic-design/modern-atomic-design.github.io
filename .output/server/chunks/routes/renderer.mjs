...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Modern Atomic Design - Articles about design systems, atomic design, and component architecture"},{"name":"format-detection","content":"telephone=no"},{"property":"og:image","content":"/preview.png"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Modern Atomic Design","htmlAttrs":{"lang":"en"}};
